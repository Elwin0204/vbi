    ...
    >
      ...
      <g>
        <path
          ...
          d="M23 20 L36 28 L49 20 L36 12 L23 20 Z"
          fill="#2e77f3"
          fill-opacity="0.6"
          stroke="#3283fc"
          stroke-width="1"
      ...
      <text x="65" y="32" fill="#fcfefc" style="font-size: 24px">
        {{ title }}
      </text>
    </svg>
    <div class="chart">
